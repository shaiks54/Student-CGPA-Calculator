 ...
 * ------------------------
 * A Java Swing desktop application that lets a student log in with their
 * roll number and password, then calculates and displays their SGPA (per
 * semester) and overall CGPA based on marks stored in a MySQL database.
 *
 * Requires a MySQL database named "project" with tables:
 *   - student(Name, Roll, Branch, Section, password)
 *   - First_Sem(roll, C, BC)
 *   - Sec_Sem(roll, Java, DBMS)
 *
 * Update DB_URL / DB_USER / DB_PASSWORD below to match your local setup.
 */
public class StudentCgpaCalculator {
    ...
    private static final String DB_PASSWORD = "1234"; // change this for your local MySQL setup
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    StudentCgpaCalculator window = new StudentCgpaCalculator();
    ...
    private void initialize() {
        ...
        panel.setBorder(new TitledBorder(null, "Student_Details",
        ...
        panel_1.setBorder(new TitledBorder(null, "CGPA", TitledBorder.LEADING,
        ...
        panel_2.setBorder(new TitledBorder(null, "Login_Page",
                TitledBorder.LEADING, TitledBorder.TOP, null, null));
        ...
        btnlog.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    String sql = "select Name,Roll,Branch,Section from student where roll='"
                    ...
                    if (rs.next()) {
                        ...
                        if (username.equals("") && pass.equals(""))
                            btnNotification.setText("=> Enter UserId and Password <=");
                        else if (username.length() == 0)
                            btnNotification.setText("=> Enter Student ID <=");
                        else if (pass.length() == 0)
                            btnNotification.setText("=> Enter Password <=");
                        else
